        ...
        <Segment>
            ...
            <>
                ...
                {({errors, isSubmitting, isValid, dirty}) => ( 
                    ...
                    <Button style={{display: 'block'}} type='submit' loading={isSubmitting} disabled={!isValid || isSubmitting || !dirty} size='large' positive content='Update password'/>
                    </Form>
            ...
            <>
                ...
                <Button icon='google' color='google plus' as={Link} to='https://facebook.com' content='Go to Google' />
            </>}
        </Segment>
    )
}